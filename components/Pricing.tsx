...
const PricingCard = ({ plan, onBookCall }: { plan: any, onBookCall?: () => void }) => {
...
const Pricing: React.FC<PricingProps> = ({ onBookCall }) => {
  return (
    <section className={styles.pricing} id="pricing">
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          {PLANS.map((plan) => (
            <PricingCard key={plan.id} plan={plan} onBookCall={onBookCall} />
          ))}
        </div>
      </div>
    </section>
